...
export default function NatureDocumentary() {
  return (
    <div className="min-h-screen bg-[#f5f0e8] text-[#2d3a2d] font-['system-ui','-apple-system',sans-serif]">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#2d3a2d] text-[#f5f0e8]">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs tracking-[0.3em] uppercase">Nature Documentary</span>
          </div>
        </div>
      </nav>
      ...
      <footer className="py-8 bg-[#2d3a2d] text-[#f5f0e8]">
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center text-sm">
          <p className="text-[#f5f0e8]/60">DarkWebIQ — Nature Documentary Theme Preview</p>
