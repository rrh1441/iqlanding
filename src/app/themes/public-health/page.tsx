  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 font-['system-ui','-apple-system','Segoe_UI',Roboto,sans-serif]">
      ...
      <nav className="bg-[#1a5f4a] text-white sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-6">
            <span className="text-xs tracking-wider uppercase text-white/60">Cyber Health Dashboard</span>
          </div>
        </div>
      </nav>

      {/* Hero Section - Health Advisory */}
      ...
      <section className="py-16 bg-[#1a5f4a]/5">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <span className="text-[#1a5f4a] text-sm font-semibold tracking-wider uppercase">Treatment Options</span>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <span className="text-[#1a5f4a] text-sm font-semibold tracking-wider uppercase">Case Studies</span>
      ...
      <footer className="py-8 bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center text-sm">
          <p className="text-gray-400">DarkWebIQ — Public Health Theme Preview</p>
