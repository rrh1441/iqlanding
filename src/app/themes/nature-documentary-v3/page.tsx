...
export default function NatureDocumentaryV3() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f0e8] text-[#2d3a2d] font-['system-ui','-apple-system',sans-serif]">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#2d3a2d]/95 backdrop-blur text-[#f5f0e8]">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-6">
            ...
            <button className="bg-[#d97706] text-white py-2.5 px-6 text-sm font-medium tracking-wide hover:bg-[#b45309] transition-colors rounded-sm">
              {content.hero.cta}
            </button>
          </div>
        </div>
      ...
      {/* 14. Guarantee Section - Safe Passage */}
      <section className="py-20 bg-[#e8e0d4]">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <div className="bg-white rounded-lg p-12 shadow-md">
            ...
            <h2 className="text-3xl font-light text-[#2d3a2d] mb-4">{content.guarantee.headline}</h2>
            <p className="text-lg text-[#2d3a2d]/80 mb-4">{content.guarantee.text}</p>
            <p className="text-sm text-[#d97706] italic">{content.guarantee.subtext}</p>
          </div>
        </div>
      </section>
